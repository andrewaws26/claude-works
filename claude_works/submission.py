...
ATS_GOTCHAS: dict[str, list[str]] = {
    ...
    "greenhouse": [
        ...
        "An HTTP 428 on the submit POST is the emailed-code gate announcing itself, not an error: the form re-renders with the 8-box security-code group and a disabled Submit. Proceed with the standard inbox-read flow; after typing the code, re-find the Submit button fresh because the pre-gate element reference goes stale.",
    ],
    "lever": [
