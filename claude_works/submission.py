...
ATS_GOTCHAS: dict[str, list[str]] = {
    ...
    "greenhouse": [
        ...
        "The code box is eight separate single-character inputs with ids security-input-0 through security-input-7, not one eight-character field. Click the first box and type the characters with a small per-key delay so focus auto-advances, then verify by joining the eight values; the submit button re-enables once all eight hold a character.",
